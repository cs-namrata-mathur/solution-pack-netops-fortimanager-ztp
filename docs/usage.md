...
- [Provisioning Flow using multiple ZTP Profiles Example](./usage/example1.md): Demonstrates how to provision four unauthorized FortiGate virtual machines in FortiManager by assigning a ZTP profile.
